...
export type StepperProps<Element extends ElementType = PolymorphicDefaultElement> = BoxProps<Element, StepperOtherProps>;
export type StepperRef<Element extends ElementType = PolymorphicDefaultElement> = BoxRef<Element>;
type PickedStepperProps = 'color' | 'colorMode' | 'align' | 'index' | 'total' | 'isConsecutively' | 'isDisabled' | 'isFitted' | 'onChange' | 'orientation' | 'size' | 'spacing' | 'variant';
