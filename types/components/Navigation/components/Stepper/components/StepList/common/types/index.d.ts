...
export type StepListRenderProps<Element extends ElementType = PolymorphicDefaultElement> = Pick<StepperProps<Element>, 'color' | 'colorMode'> & {
    w?: number;
    h?: number;
};
...
export type StepListProps<Element extends ElementType = PolymorphicDefaultElement> = Omit<BoxProps<Element, StepListOtherProps<Element>>, keyof BoxOtherProps>;
