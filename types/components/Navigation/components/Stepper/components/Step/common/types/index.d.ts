...
export type StepRenderProps<Element extends StepElement = StepDefaultElement> = Pick<StepOtherProps<Element>, 'color' | 'colorMode'> & {
    w?: number;
    h?: number;
};
...
export type StepProps<Element extends StepElement = StepDefaultElement> = Omit<BoxProps<Element, StepOtherProps<Element>>, keyof BoxOtherProps>;
export type StepRef<Element extends StepElement = StepDefaultElement> = BoxRef<Element>;
export type StepContext<Element extends StepElement = StepDefaultElement> = Pick<StepProps<Element>, 'index' | 'status'> & {
    id: string;
};
export {};
