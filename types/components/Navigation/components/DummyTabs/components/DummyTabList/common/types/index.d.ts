...
export type DummyTabListRenderProps<Element extends ElementType = PolymorphicDefaultElement> = Pick<DummyTabsProps<Element>, 'color' | 'colorMode'> & {
    w?: number;
    h?: number;
};
...
export type DummyTabListProps<Element extends ElementType = PolymorphicDefaultElement> = Omit<BoxProps<Element, DummyTabListOtherProps<Element>>, keyof BoxOtherProps>;
