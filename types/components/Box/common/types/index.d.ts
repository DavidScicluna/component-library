...
import type { Nullish, PolymorphicComponentProps, PolymorphicDefaultElement, PolymorphicDefaultProps, PolymorphicRef, ResponsiveValue, Style, ThemeSpacing } from '@common/types';
...
export type BoxProps<Element extends ElementType = PolymorphicDefaultElement, Props = PolymorphicDefaultProps> = PolymorphicComponentProps<Element, Props & BoxOtherProps>;
