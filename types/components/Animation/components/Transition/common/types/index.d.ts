...
import type { AnimationConfig, PolymorphicDefaultElement, ResponsiveValue, Style, ThemeDelay, ThemeDuration, ThemeEase } from '@common/types';
import type { BoxProps, BoxRef } from '@components/Box';
export type TransitionDelay = ThemeDelay | number;
export type TransitionDuration = ThemeDuration | number;
export type TransitionKey = 'fade' | 'collapse' | 'skew-up' | 'skew-down' | 'rotate-right' | 'rotate-left' | 'slide-down' | 'slide-up' | 'slide-right' | 'slide-left' | 'scale-y' | 'scale-x' | 'scale' | 'pop' | 'pop-top-left' | 'pop-top-right' | 'pop-bottom-left' | 'pop-bottom-right';
...
export type TransitionProps<Element extends ElementType = PolymorphicDefaultElement> = BoxProps<Element, TransitionOtherProps>;
