...
export type ModalSize = PickFrom<ThemeFontSize, 'xs' | 'sm' | 'md' | 'lg' | 'xl' | '2xl' | '3xl' | '4xl' | '5xl' | '6xl' | '7xl'> | 'full';
...
export type ModalRenderBackdropProps<Element extends ModalElement = ModalDefaultElement> = Pick<ModalProps<Element>, 'color' | 'colorMode'>;
...
export type ModalProps<Element extends ModalElement = ModalDefaultElement> = Omit<BoxProps<Element, ModalOtherProps>, keyof BoxOtherProps>;
