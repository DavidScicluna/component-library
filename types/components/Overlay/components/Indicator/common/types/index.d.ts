...
export type IndicatorPlacement = 'bottom-center' | 'bottom-end' | 'bottom-start' | 'top-end' | 'top-start' | 'top-center' | 'middle-center' | 'middle-end' | 'middle-start';
...
export type IndicatorProps<Element extends ElementType = PolymorphicDefaultElement> = BoxProps<Element, IndicatorOtherProps>;
