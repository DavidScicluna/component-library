...
import type { GradientClass, GradientFromMiddleToClass, PolymorphicDefaultElement, ResponsiveValue, ThemeAppColorMode, ThemeColor } from '@common/types';
...
export type LinearGradientProps<Element extends ElementType = PolymorphicDefaultElement> = BoxProps<Element, LinearGradientOtherProps>;
