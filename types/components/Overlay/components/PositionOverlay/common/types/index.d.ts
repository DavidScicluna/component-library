...
export type PositionOverlayPlacement = 'bottom-center' | 'bottom-end' | 'bottom-start' | 'top-end' | 'top-start' | 'top-center' | 'middle-center' | 'middle-end' | 'middle-start';
...
export type PositionOverlayProps<Element extends ElementType = PolymorphicDefaultElement> = BoxProps<Element, PositionOverlayOtherProps<Element>>;
