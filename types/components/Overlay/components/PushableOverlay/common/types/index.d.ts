...
export type PushableOverlayVariant = 'contained' | 'light' | 'dark' | 'outlined' | 'monochrome' | 'transparent' | 'unstyled';
...
export type PushableOverlayProps<Element extends ElementType = PolymorphicDefaultElement> = BoxProps<Element, PushableOverlayOtherProps>;
