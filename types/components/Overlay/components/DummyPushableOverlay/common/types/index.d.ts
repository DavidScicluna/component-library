...
export type DummyPushableOverlayVariant = 'contained' | 'light' | 'dark' | 'outlined' | 'monochrome' | 'transparent' | 'unstyled';
...
export type DummyPushableOverlayProps<Element extends ElementType = PolymorphicDefaultElement> = BoxProps<Element, DummyPushableOverlayOtherProps>;
