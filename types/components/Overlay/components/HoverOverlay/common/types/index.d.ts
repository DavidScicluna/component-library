...
export type HoverOverlayMouseEvent<Element extends ElementType = PolymorphicDefaultElement> = PolymorphicMouseEvent<Element>;
...
export type HoverOverlayProps<Element extends ElementType = PolymorphicDefaultElement> = Omit<BoxProps<Element, HoverOverlayOtherProps>, 'children'>;
