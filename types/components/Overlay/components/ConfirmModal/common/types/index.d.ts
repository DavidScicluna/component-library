...
export type ConfirmModalRenderTriggerProps<Element extends ConfirmModalElement = ConfirmModalDefaultElement> = BoxProps & {
    /**
...
export type ConfirmModalRenderBackdropProps<Element extends ConfirmModalElement = ConfirmModalDefaultElement> = Pick<ConfirmModalProps<Element>, 'color' | 'colorMode'>;
export type ConfirmModalRenderCancelProps<Element extends ConfirmModalElement = ConfirmModalDefaultElement> = Pick<ConfirmModalProps<Element>, 'color' | 'colorMode'>;
type ConfirmModalOtherProps<Element extends ConfirmModalElement = ConfirmModalDefaultElement> = ThemeAppAppearanceProps & {
...
export type ConfirmModalProps<Element extends ConfirmModalElement = ConfirmModalDefaultElement> = Omit<BoxProps<Element, ConfirmModalOtherProps<Element>>, keyof BoxOtherProps>;
