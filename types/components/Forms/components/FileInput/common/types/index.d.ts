...
import type { PickFrom, PolymorphicChangeEvent, PolymorphicFocusEvent, PolymorphicMouseEvent, ResponsiveValue } from '@common/types';
import type { BoxOtherProps, BoxProps, BoxRef } from '@components/Box';
import type { FormsCommonProps, FormsCommonSize, FormsCommonVariant } from '@components/Forms';
export type FileInputMouseEvent<Element extends FileInputElement = FileInputDefaultElement> = PolymorphicMouseEvent<Element>;
export type FileInputChangeEvent<Element extends FileInputElement = FileInputDefaultElement> = PolymorphicChangeEvent<Element>;
export type FileInputFocusEvent<Element extends FileInputElement = FileInputDefaultElement> = PolymorphicFocusEvent<Element>;
...
export type FileInputRenderProps<Element extends FileInputElement = FileInputDefaultElement> = Pick<FileInputOtherProps<Element>, 'color' | 'colorMode'> & {
    w?: number;
    h?: number;
};
...
export type FileInputProps<Element extends FileInputElement = FileInputDefaultElement> = Omit<BoxProps<Element, FileInputOtherProps<Element>>, OmittedBoxProps>;
