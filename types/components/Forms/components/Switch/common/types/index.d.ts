...
export type SwitchChangeEvent<Element extends ElementType = PolymorphicDefaultElement> = PolymorphicChangeEvent<Element>;
...
export type SwitchProps<Element extends ElementType = PolymorphicDefaultElement> = Omit<BoxProps<Element, SwitchOtherProps>, OmittedBoxProps>;
