...
export type SearchInputMouseEvent<Element extends SearchInputElement = SearchInputDefaultElement> = PolymorphicMouseEvent<Element>;
export type SearchInputChangeEvent<Element extends SearchInputElement = SearchInputDefaultElement> = PolymorphicChangeEvent<Element>;
export type SearchInputFocusEvent<Element extends SearchInputElement = SearchInputDefaultElement> = PolymorphicFocusEvent<Element>;
...
export type SearchInputRenderClearProps = Pick<IconButtonProps, 'color' | 'colorMode' | 'isCompact' | 'onClick' | 'size' | 'variant'>;
export type SearchInputRenderSubmitProps = Pick<ButtonProps, 'color' | 'colorMode' | 'isCompact' | 'isDisabled' | 'isRound' | 'onClick' | 'size' | 'variant'>;
export type SearchInputRenderProps<Element extends SearchInputElement = SearchInputDefaultElement> = Pick<SearchInputOtherProps<Element>, 'color' | 'colorMode'> & {
    w?: number;
    h?: number;
};
...
type OmittedBoxProps = 'children' | 'onChange' | 'value' | keyof Omit<BoxOtherProps, 'w' | 'minW' | 'maxW' | 'h' | 'minH' | 'maxH'>;
export type SearchInputProps<Element extends SearchInputElement = SearchInputDefaultElement> = Omit<BoxProps<Element, SearchInputOtherProps<Element>>, OmittedBoxProps>;
