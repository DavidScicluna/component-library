...
export type NumberInputMouseEvent<Element extends NumberInputElement = NumberInputDefaultElement> = PolymorphicMouseEvent<Element>;
export type NumberInputChangeEvent<Element extends NumberInputElement = NumberInputDefaultElement> = PolymorphicChangeEvent<Element>;
export type NumberInputFocusEvent<Element extends NumberInputElement = NumberInputDefaultElement> = PolymorphicFocusEvent<Element>;
...
export type NumberInputRenderProps<Element extends NumberInputElement = NumberInputDefaultElement> = Pick<NumberInputOtherProps<Element>, 'color' | 'colorMode'> & {
    w?: number;
    h?: number;
};
...
export type NumberInputProps<Element extends NumberInputElement = NumberInputDefaultElement> = Omit<BoxProps<Element, NumberInputOtherProps<Element>>, OmittedBoxProps>;
