...
import type { PickFrom, PolymorphicChangeEvent, PolymorphicFocusEvent, PolymorphicMouseEvent, ResizeClass, ResponsiveValue } from '@common/types';
import type { BoxOtherProps, BoxProps, BoxRef } from '@components/Box';
import type { FormsCommonProps, FormsCommonSize, FormsCommonVariant } from '@components/Forms';
import type { TextProps } from '@components/Typography';
export type TextareaMouseEvent<Element extends TextareaElement = TextareaDefaultElement> = PolymorphicMouseEvent<Element>;
export type TextareaChangeEvent<Element extends TextareaElement = TextareaDefaultElement> = PolymorphicChangeEvent<Element>;
export type TextareaFocusEvent<Element extends TextareaElement = TextareaDefaultElement> = PolymorphicFocusEvent<Element>;
...
export type TextareaRenderProps<Element extends TextareaElement = TextareaDefaultElement> = Pick<TextareaOtherProps<Element>, 'color' | 'colorMode'> & {
    w?: number;
    h?: number;
};
...
export type TextareaProps<Element extends TextareaElement = TextareaDefaultElement> = Omit<BoxProps<Element, TextareaOtherProps>, OmittedBoxProps>;
