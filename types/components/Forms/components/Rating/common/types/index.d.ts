...
type PickedFormsCommonProps = 'color' | 'colorMode' | 'isDisabled' | 'isError' | 'isReadOnly' | 'isRequired' | 'isSuccess' | 'isWarning' | 'size';
...
export type RatingProps<Element extends ElementType = PolymorphicDefaultElement> = Omit<BoxProps<Element, RatingOtherProps>, OmittedBoxProps>;
