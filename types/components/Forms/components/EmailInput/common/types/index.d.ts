...
export type EmailInputMouseEvent<Element extends EmailInputElement = EmailInputDefaultElement> = PolymorphicMouseEvent<Element>;
export type EmailInputChangeEvent<Element extends EmailInputElement = EmailInputDefaultElement> = PolymorphicChangeEvent<Element>;
export type EmailInputFocusEvent<Element extends EmailInputElement = EmailInputDefaultElement> = PolymorphicFocusEvent<Element>;
...
export type EmailInputRenderProps<Element extends EmailInputElement = EmailInputDefaultElement> = Pick<EmailInputOtherProps<Element>, 'color' | 'colorMode'> & {
    w?: number;
    h?: number;
};
...
export type EmailInputProps<Element extends EmailInputElement = EmailInputDefaultElement> = Omit<BoxProps<Element, EmailInputOtherProps<Element>>, OmittedBoxProps>;
