...
export type TextInputMouseEvent<Element extends TextInputElement = TextInputDefaultElement> = PolymorphicMouseEvent<Element>;
export type TextInputChangeEvent<Element extends TextInputElement = TextInputDefaultElement> = PolymorphicChangeEvent<Element>;
export type TextInputFocusEvent<Element extends TextInputElement = TextInputDefaultElement> = PolymorphicFocusEvent<Element>;
...
export type TextInputRenderProps<Element extends TextInputElement = TextInputDefaultElement> = Pick<TextInputOtherProps<Element>, 'color' | 'colorMode'> & {
    w?: number;
    h?: number;
};
...
export type TextInputProps<Element extends TextInputElement = TextInputDefaultElement> = Omit<BoxProps<Element, TextInputOtherProps<Element>>, OmittedBoxProps>;
