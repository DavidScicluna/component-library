...
export type DummyIconButtonProps<Element extends ElementType = PolymorphicDefaultElement> = Omit<BoxProps<Element, DummyIconButtonOtherProps<Element>>, keyof BoxOtherProps>;
export type DummyIconButtonRef<Element extends ElementType = PolymorphicDefaultElement> = BoxRef<Element>;
export type DummyIconButtonContext<Element extends ElementType = PolymorphicDefaultElement> = Pick<DummyIconButtonProps<Element>, 'color' | 'colorMode' | 'size' | 'variant'>;
export {};
