...
export type IconButtonMouseEvent<Element extends IconButtonElement = IconButtonDefaultElement> = PolymorphicMouseEvent<Element>;
...
export type IconButtonRenderProps<Element extends IconButtonElement = IconButtonDefaultElement> = Pick<IconButtonOtherProps<Element>, 'color' | 'colorMode'>;
...
export type IconButtonProps<Element extends IconButtonElement = IconButtonDefaultElement> = Omit<BoxProps<Element, IconButtonOtherProps<Element>>, keyof BoxOtherProps>;
export type IconButtonRef<Element extends IconButtonElement = IconButtonDefaultElement> = BoxRef<Element>;
export type IconButtonContext<Element extends IconButtonElement = IconButtonDefaultElement> = Pick<IconButtonProps<Element>, 'color' | 'colorMode' | 'size' | 'variant'>;
export {};
