...
export type ButtonRenderProps<Element extends ButtonElement = ButtonDefaultElement> = Pick<ButtonOtherProps<Element>, 'color' | 'colorMode'> & {
    w?: number;
    h?: number;
};
...
export type ButtonProps<Element extends ButtonElement = ButtonDefaultElement> = Omit<BoxProps<Element, ButtonOtherProps<Element>>, keyof BoxOtherProps>;
export type ButtonRef<Element extends ButtonElement = ButtonDefaultElement> = BoxRef<Element>;
export type ButtonContext<Element extends ButtonElement = ButtonDefaultElement> = Pick<ButtonProps<Element>, 'color' | 'colorMode' | 'size' | 'variant'>;
export {};
