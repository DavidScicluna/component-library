...
export type ProgressSectionProps<Element extends ElementType = PolymorphicDefaultElement> = Omit<BoxProps<Element, ProgressSectionOtherProps>, keyof BoxOtherProps>;
