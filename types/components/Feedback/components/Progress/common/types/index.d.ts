...
export type ProgressProps<Element extends ElementType = PolymorphicDefaultElement> = Omit<BoxProps<Element, ProgressOtherProps>, OmittedBoxProps>;
export type ProgressRef<Element extends ElementType = PolymorphicDefaultElement> = BoxRef<Element>;
export type ProgressContext<Element extends ElementType = PolymorphicDefaultElement> = Pick<ProgressProps<Element>, 'color' | 'colorMode' | 'isIndeterminate' | 'max' | 'min' | 'radius' | 'variant'>;
export {};
