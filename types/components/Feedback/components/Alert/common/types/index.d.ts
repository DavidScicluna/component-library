...
import type { Nullish, PolymorphicDefaultElement, ResponsiveValue, ThemeAppAppearanceProps, ThemeSpacing } from '@common/types';
...
export type AlertRenderCloseProps = Pick<IconButtonProps, 'color' | 'colorMode' | 'isCompact' | 'onClick' | 'size' | 'variant'>;
...
export type AlertProps<Element extends ElementType = PolymorphicDefaultElement> = Omit<BoxProps<Element, AlertOtherProps>, keyof BoxOtherProps>;
export type AlertRef<Element extends ElementType = PolymorphicDefaultElement> = BoxRef<Element>;
export type AlertContext<Element extends ElementType = PolymorphicDefaultElement> = Pick<AlertProps<Element>, 'color' | 'colorMode' | 'status' | 'variant'>;
export {};
