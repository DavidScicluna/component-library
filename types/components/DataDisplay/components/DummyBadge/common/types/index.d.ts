...
export type DummyBadgeRenderProps<Element extends ElementType = PolymorphicDefaultElement> = Pick<DummyBadgeOtherProps<Element>, 'color' | 'colorMode'> & {
    w?: number;
    h?: number;
};
...
export type DummyBadgeProps<Element extends ElementType = PolymorphicDefaultElement> = Omit<BoxProps<Element, DummyBadgeOtherProps<Element>>, keyof BoxOtherProps>;
export type DummyBadgeRef<Element extends ElementType = PolymorphicDefaultElement> = BoxRef<Element>;
export type DummyBadgeContext<Element extends ElementType = PolymorphicDefaultElement> = Pick<DummyBadgeProps<Element>, 'color' | 'colorMode' | 'size' | 'variant'>;
export {};
