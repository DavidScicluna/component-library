...
import type { BackgroundAttachmentClass, BackgroundBlendModeClass, BackgroundClipClass, BackgroundOriginClass, BackgroundPositionClass, BackgroundRepeatClass, BackgroundSizeClass, BrightnessClass, ContrastClass, GrayscaleClass, HueRotateClass, InvertClass, PolymorphicDefaultElement, ResponsiveValue, SaturateClass, SepiaClass, ThemeBlurClass, ThemeRadius } from '@common/types';
...
export type BackgroundImageProps<Element extends ElementType = PolymorphicDefaultElement> = BoxProps<Element, BackgroundImageOtherProps>;
