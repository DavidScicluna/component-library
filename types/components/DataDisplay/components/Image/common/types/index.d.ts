...
import type { BrightnessClass, ContrastClass, GrayscaleClass, HueRotateClass, InvertClass, PolymorphicDefaultElement, ResponsiveValue, SaturateClass, SepiaClass, ThemeAppAppearanceProps, ThemeBlurClass, ThemeRadius } from '@common/types';
...
export type ImageProps<Element extends ElementType = PolymorphicDefaultElement> = Omit<BoxProps<Element, ImageOtherProps>, 'children'>;
