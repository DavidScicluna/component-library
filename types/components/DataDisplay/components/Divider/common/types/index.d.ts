...
export type DividerThemeAppearanceProps = Partial<Pick<ThemeAppearanceProps, 'colorMode'> & {
...
export type DividerProps<Element extends DividerElement> = Omit<BoxProps<Element, DividerOtherProps>, keyof BoxOtherProps>;
