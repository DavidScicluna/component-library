...
import { handleIsTouchDevice, handleConvertREMToPixels, handleConvertStringToNumber, handleHue } from './common/utils';
...
// Utils
export { handleIsTouchDevice, handleConvertREMToPixels, handleConvertStringToNumber, handleHue };
