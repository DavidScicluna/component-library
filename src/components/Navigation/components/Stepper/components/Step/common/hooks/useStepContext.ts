...
import type { StepContext as StepContextType, StepDefaultElement, StepElement } from '../types';

import { useStepResponsiveValues } from '.';

const useStepContext = <Element extends StepElement = StepDefaultElement>() => {
	const {
		id,
