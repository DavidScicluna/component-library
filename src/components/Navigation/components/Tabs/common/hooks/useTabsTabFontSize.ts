...
type UseTabsTabFontSizeProps<Element extends ElementType> = Pick<TabsProps<Element>, 'size'>;

const useTabsTabFontSize = <Element extends ElementType>(props: UseTabsTabFontSizeProps<Element>): number => {
