...
type UseGridStylesProps<Element extends ElementType = PolymorphicDefaultElement> = Pick<
	GridProps<Element>,
	'templateColumns' | 'templateRows'
>;
type UseGridStylesReturn = Style;

const useGridStyles = <Element extends ElementType = PolymorphicDefaultElement>(
