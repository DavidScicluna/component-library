...
type UseSpaceClassesProps<Element extends PolymorphicElementType = PolymorphicDefaultElement> = Pick<
	SpaceProps<Element>,
	'width' | 'height'
>;
type UseSpaceClassesReturn = ClassName;

const useSpaceClasses = <Element extends PolymorphicElementType = PolymorphicDefaultElement>(
