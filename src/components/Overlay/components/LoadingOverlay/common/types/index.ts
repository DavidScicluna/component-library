...
type LoadingOverlayOtherProps<Element extends PolymorphicElementType = PolymorphicDefaultElement> =
	ThemeAppAppearanceProps & {
...
export type LoadingOverlayProps<Element extends PolymorphicElementType = PolymorphicDefaultElement> = BoxProps<
	Element,
	LoadingOverlayOtherProps<Element>
>;

export type LoadingOverlayRef<Element extends PolymorphicElementType = PolymorphicDefaultElement> = BoxRef<Element>;
