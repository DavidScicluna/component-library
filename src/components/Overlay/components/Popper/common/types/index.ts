...
export type PopperRenderTriggerProps<Element extends PolymorphicElementType> = {
	/**
...
export type PopperOtherProps<Element extends PolymorphicElementType> = ThemeAppAppearanceProps & {
