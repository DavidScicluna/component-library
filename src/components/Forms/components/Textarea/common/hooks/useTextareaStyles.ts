...
import { __KEYS_TEXTAREA_TOTAL_CLASS__ } from '../keys';
import type { TextareaDefaultElement, TextareaElement, TextareaProps, TextareaVariant } from '../types';

type UseTextareaStylesProps<Element extends TextareaElement = TextareaDefaultElement> = Pick<
	...
	| 'variant'
>;
type UseTextareaStylesReturn = Style;

const useTextareaStyles = <Element extends TextareaElement = TextareaDefaultElement>(
	props: UseTextareaStylesProps<Element>
): UseTextareaStylesReturn => {
