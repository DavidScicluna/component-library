...
export const __DEFAULT_INPUT_IS_ERROR__ = false;
export const __DEFAULT_INPUT_IS_FOCUSED__ = false;
export const __DEFAULT_INPUT_IS_OUTLINED__ = false;
export const __DEFAULT_INPUT_IS_READONLY__ = false;
...
export const __DEFAULT_INPUT_VARIANT__: InputVariant = 'outlined';
