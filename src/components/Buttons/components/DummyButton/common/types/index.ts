...
export type DummyButtonRenderProps<Element extends PolymorphicElementType = PolymorphicDefaultElement> = Pick<
	DummyButtonOtherProps<Element>,
	'color' | 'colorMode'
> & { w?: number; h?: number };

type DummyButtonOtherProps<Element extends PolymorphicElementType = PolymorphicDefaultElement> =
	ThemeAppAppearanceProps & {
...
export type DummyButtonProps<Element extends PolymorphicElementType = PolymorphicDefaultElement> = Omit<
	BoxProps<Element, DummyButtonOtherProps<Element>>,
	keyof BoxOtherProps
>;

export type DummyButtonRef<Element extends PolymorphicElementType = PolymorphicDefaultElement> = BoxRef<Element>;
