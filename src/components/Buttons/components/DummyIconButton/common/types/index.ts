...
type DummyIconButtonOtherProps<Element extends PolymorphicElementType = PolymorphicDefaultElement> =
	ThemeAppAppearanceProps & {
		/**
...
export type DummyIconButtonProps<Element extends PolymorphicElementType = PolymorphicDefaultElement> = Omit<
	BoxProps<Element, DummyIconButtonOtherProps<Element>>,
	keyof BoxOtherProps
>;

export type DummyIconButtonRef<Element extends PolymorphicElementType = PolymorphicDefaultElement> = BoxRef<Element>;
