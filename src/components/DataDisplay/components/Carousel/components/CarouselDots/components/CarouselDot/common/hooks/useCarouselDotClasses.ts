...
type UseCarouselDotClassesProps<Element extends ElementType = PolymorphicDefaultElement> = Pick<
...
const useCarouselDotClasses = <Element extends ElementType = PolymorphicDefaultElement>(
