...
export type DummyBadgeRenderProps<Element extends PolymorphicElementType = PolymorphicDefaultElement> = Pick<
	DummyBadgeOtherProps<Element>,
	'color' | 'colorMode'
> & { w?: number; h?: number };

type DummyBadgeOtherProps<Element extends PolymorphicElementType = PolymorphicDefaultElement> =
	ThemeAppAppearanceProps & {
		/**
...
export type DummyBadgeProps<Element extends PolymorphicElementType = PolymorphicDefaultElement> = Omit<
	BoxProps<Element, DummyBadgeOtherProps<Element>>,
	keyof BoxOtherProps
>;

export type DummyBadgeRef<Element extends PolymorphicElementType = PolymorphicDefaultElement> = BoxRef<Element>;

export type DummyBadgeContext = Pick<DummyBadgeProps, 'color' | 'colorMode' | 'size' | 'variant'>;
